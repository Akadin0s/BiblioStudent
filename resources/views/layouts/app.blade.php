                    ...
                    <div class="collapse navbar-collapse justify-content-center align-items-center" id="navbarNav" style="margin-left: -12%;">
                        <ul class="navbar-nav">
                            <li class="nav-item me-3">
                                <a class="nav-link fs-3 animated-underline {{ request()->routeIs('home') ? 'active' : '' }}" aria-current="page"
                                    href="{{ route('home') }}">{{ __('Home') }}</a>
                            </li>
                            <li class="nav-item me-3">
                                <a class="nav-link fs-3 animated-underline {{ request()->routeIs('Documents') ? 'active' : '' }}"
                                    href="{{ route('Documents') }}">{{ __('Documents') }}</a>
                            </li>
                        </ul>
                    </div>
